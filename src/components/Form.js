            ...
            <form className='form' onSubmit={handleSubmit}>
                ...
                <div className='form-c'>
                    <select name="class" required onChange={handleChange}>
                        <option defaultValue >SelectType</option>
                        <option value='Regular'>Regular </option>
                        <option value='Large'>Large </option>
                    </select>
                </div>
                <div className='form-d'>
                    <input type='text' required name='adults' value={formData.adults} onChange={handleChange} placeholder='Servings' />
                   {/* <input type='text' required name='children' value={formData.children} onChange={handleChange} placeholder='CashOnDelivery' /> */}
                </div>
